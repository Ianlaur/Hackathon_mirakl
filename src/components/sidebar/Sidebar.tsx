      ...
      >
        ...
        <div className="flex items-center justify-between px-4 pb-4 pt-6">
          <div className={`overflow-hidden transition-all duration-300 ${collapsed ? 'w-0 opacity-0' : 'w-auto opacity-100'}`}>
            <div className="whitespace-nowrap font-serif text-lg font-bold tracking-widest text-[#03182F]">
              MIRAKL CONNECT
            </div>
            <div className="mt-1 text-xs uppercase tracking-wider text-[#6B7480]">Operations</div>
          </div>
        </div>
