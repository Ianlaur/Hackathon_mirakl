...
const CITY_COORDINATES: CityCoordinate[] = [
  ...
  { keywords: ['geneva', 'geneva', 'geneva'], label: 'Geneva', lat: 46.2044, lng: 6.1432 },
  ...
  { keywords: ['montreal', 'montreal'], label: 'Montreal', lat: 45.5017, lng: -73.5673 },
  ...
  { keywords: ['beijing', 'beijing', 'beijing'], label: 'Beijing', lat: 39.9042, lng: 116.4074 },
...
const GEO_REGIONS: GeoRegion[] = [
  ...
  { keywords: ['united states', 'usa', 'united states', 'united states'], lat: 39.8283, lng: -98.5795, spreadLat: 11, spreadLng: 18 },
  ...
  { keywords: ['south korea', 'south korea', 'south korea'], lat: 35.9078, lng: 127.7669, spreadLat: 2.5, spreadLng: 3 },
